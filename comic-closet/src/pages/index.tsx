...
export const getStaticProps: GetStaticProps = async() => {
  ...
  const hash:string = md5(timestamp + process.env.NEXT_PUBLIC_PRIVATE_API_KEY + process.env.NEXT_PUBLIC_API_KEY)
  
  let API_URL: string = `https://gateway.marvel.com/v1/public/comics?ts=${timestamp}&apikey=${process.env.NEXT_PUBLIC_API_KEY}&hash=${hash}`
